...
#ifndef PHYSICALLY_BASED_ANIMATIONS_VULKAN_SRC_PCH_HPP
#define PHYSICALLY_BASED_ANIMATIONS_VULKAN_SRC_PCH_HPP
...
#endif  // PHYSICALLY_BASED_ANIMATIONS_VULKAN_SRC_PCH_HPP
